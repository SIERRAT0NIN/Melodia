...
Revision ID: 86a09f95a325
Revises: 
Create Date: 2023-12-30 01:23:25.369296
...
def upgrade():
    ...
    sa.Column('song_basket_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['song_basket_id'], ['song_baskets.id'], name=op.f('fk_songs_song_basket_id_song_baskets')),
    sa.PrimaryKeyConstraint('id')
    )
